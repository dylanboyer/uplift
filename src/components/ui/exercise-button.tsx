...
const ExerciseButton: React.FC<ExerciseButtonProps> = ({
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={onClick}
        className={`w-52 h-52 p-4 rounded-lg transition-colors z-10 ${
          isNew
        ...
        {!isNew && (
          <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-2">
            ...
            <div className="relative group">
              ...
              <div className="absolute bottom-8 right-0 hidden group-hover:block bg-black text-white text-xs rounded-md p-1 whitespace-nowrap z-50">
                Delete Exercise
              </div>
            </div>
